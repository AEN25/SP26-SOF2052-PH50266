namespace DABanTuiXach
{
	partial class SanPham
	{
		...
		private void InitializeComponent()
		{
			...
			tabControl1.Size = new Size(2196, 1357);
			...
			tabPage1.Size = new Size(2188, 1308);
			tabPage1.TabIndex = 0;
			...
			// txtTimKiemSanPham
			// 
			txtTimKiemSanPham.Location = new Point(1492, 432);
			...
			// txtKieuDang
			// 
			txtKieuDang.Location = new Point(1395, 158);
			...
			// txtSize
			// 
			txtSize.Location = new Point(356, 271);
			...
			// btnSua
			// 
			btnSua.Location = new Point(436, 432);
			btnSua.Name = "btnSua";
			...
			txtMaSanPham.Location = new Point(356, 43);
			...
			// txtTenSanPham
			// 
			txtTenSanPham.Location = new Point(356, 163);
			...
			lbKieuDang.Location = new Point(1156, 158);
			...
			tabPage2.Size = new Size(2188, 1308);
			tabPage2.TabIndex = 1;
			...
			txtTenSanPhamCuaChitTiet.Location = new Point(1521, 122);
			...
			label9.Location = new Point(1231, 126);
			label9.Name = "label9";
			...
			// txtCRUDMauSac
			// 
			txtCRUDMauSac.Location = new Point(1844, 231);
			...
			cbbMaSanPham.Location = new Point(1521, 26);
			...
			btnClearSanPhamChiTiet.Size = new Size(184, 78);
			...
			groupBox1.Location = new Point(27, 722);
			groupBox1.Name = "groupBox1";
			groupBox1.Size = new Size(1940, 494);
			...
			btnSuaSanPhamChiTiet.Size = new Size(252, 78);
			...
			btnThemSanPhamChiTiet.Size = new Size(172, 78);
			...
			rdbtHetHang.Location = new Point(284, 534);
			...
			// 
			txtTenSanPhamChiTiet.Location = new Point(369, 142);
			...
			label4.Location = new Point(1236, 37);
			label4.Name = "label4";
			...
			txtSoLuong.Size = new Size(312, 43);
			txtSoLuong.TabIndex = 3;
			// 
			// label2
			// 
			label2.AutoSize = true;
			label2.Location = new Point(1236, 357);
			label2.Name = "label2";
